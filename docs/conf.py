...
autoprogram_cliff_application = 'cookiecutter-cliffapp-template'
...
project = 'cookiecutter-cliffapp-template'
author = 'Dave Dittrich'
copyright = '2021, Dave Dittrich'
...
# of the sidebar.
# tml_logo = 'd2-logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# tml_favicon = 'd2-logo.ico'
...
htmlhelp_basename = 'cookiecuttercliffapptemplatedoc'
...
latex_documents = [
  (master_doc,
   'cookiecutter-cliffapp-template.tex',
   'cookiecutter-cliffapp-template Documentation',
   'Dave Dittrich',
   'manual'),
]
...
texinfo_documents = [
    (master_doc,
     ...
     'Dave Dittrich',
     'cookiecutter-cliffapp-template',
     'The cookiecutter-cliffapp-template.',
     'Miscellaneous'),
]
...
epub_basename = 'cookiecutter-cliffapp-template'

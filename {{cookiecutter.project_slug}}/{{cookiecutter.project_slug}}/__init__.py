...
{{cookiecutter.project_slug.upper()}}_DATA_DIR = os.environ.get(
...
def copyright():
    ...
    copyright = textwrap.dedent(
        f"""Author:    {{cookiecutter.author}} <{{cookiecutter.author_email}}>
        Copyright: {copyright_years}, {{cookiecutter.author}}. All rights reserved.
        License:   {{cookiecutter.license}}
        URL:       https://pypi.python.org/pypi/{{cookiecutter.project_slug}}""")  # noqa
    return copyright

...
# -*- coding: utf-8 -*-
#
# Document: {{ cookiecutter.project_slug }}
...
autoprogram_cliff_application = '{{cookiecutter.project_slug}}'
...
copyright = '{{ cookiecutter.copyright_year }}, {{ cookiecutter.copyright_name }}'
...
epub_basename = '{{ cookiecutter.project_slug }}'

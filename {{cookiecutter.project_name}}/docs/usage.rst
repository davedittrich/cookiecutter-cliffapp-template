...
Subcommand groups in ``{{cookiecutter.project_name}}`` are divided by categories
...
.. literalinclude:: {{cookiecutter.project_name}}-help.txt
    :language: console
...
..
..         .. autoprogram-cliff:: {{cookiecutter.project_slug}}
..            :command: cafe info
..
...
Here is an example of logging output of the ``about`` command::
    ...
    initialize_app
    [+] command line: /usr/local/Caskroom/miniconda/base/envs/test/bin/{{cookiecutter.project_name}} -vvvv --log-file logfile about
    prepare_to_run_command About
    {{cookiecutter.project_name}} version 2021.3.0rc1
...
Here is what the output would look like::
    ...
    [2021-06-08 14:31:57,052] DEBUG    mycliffapp prepare_to_run_command About
